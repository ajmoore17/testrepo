...
# Get the min and max payload mass values
...
# TASK 2: Add a callback function to update the pie chart
@app.callback(
...
# TASK 4: Add a callback function to update the scatter plot
@app.callback(
